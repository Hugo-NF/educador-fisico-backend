...
const logOutputFormatter = printf(info => {
...
var options = {
    file: {
      ...
      colors: {ERROR: 'red', WARNING: 'yellow', INFO: 'blue', VERBOSE: 'GREEN'},
      colorize: false,                           
      // Uses colors for each level of log
      // WARNING: enabling this option will print ANSI escape characters, so it's not useful for writing to files.
